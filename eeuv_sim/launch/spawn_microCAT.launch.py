...
def generate_launch_description():
    ...
    world_path = os.path.join(uw_gazebo_path,
                              'worlds', 'auv_underwater_world_microcat.world')
    ...
    fin_joint_controller = Node(package='uw_gazebo', executable='moveFins.py',
                        parameters=[{'yaml_dynamics': "microCATDynamics.yaml",
    ...
    # Node to publish pressure feedback
    pressure = Node(package='uw_gazebo', executable='pressure.py',
                        parameters=[{'robot_model': robot_model}],
                        output='screen')
    
    # Node to publish light sensor feedback
    light_sensors = Node(package='uw_gazebo', executable='lightSensors.py',
                        output='screen')
